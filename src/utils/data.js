...
export const SKILLS_CATEGORIES = [
  {
    ...
    skills: [
      ...
      { name: "Microservices", level: 80, color: "bg-pink-500" },
    ],
  },
  {
    title: "Frontend",
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Kafka", level: 70, color: "bg-green-800" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Git", level: 90, color: "bg-gray-900" },
      { name: "GitHub Actions", level: 70, color: "bg-purple-600" },
      { name: "Jira", level: 90, color: "bg-yellow-500" },
    ],
  },
];
...
export const STATS = [
  ...
  { number: "4+", label: "Years Experience in Software Development" },
